...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<actionpack>.freeze, [">= 3.2.0", "< 7.2"])
  ...
  s.add_development_dependency(%q<standard>.freeze, ["~> 1.29"])
  s.add_development_dependency(%q<rubocop-rails>.freeze, ["~> 2.20.2"])
  s.add_development_dependency(%q<rubocop-rake>.freeze, ["~> 0.6.0"])
  s.add_development_dependency(%q<rubocop-rspec>.freeze, ["~> 2.23.0"])
